...
Consiste en dividir un disco duro en una o más particiones lógicas, donde cada una se comporta como si fuese un disco duro independiente, asignándole una unidad con una letra.
