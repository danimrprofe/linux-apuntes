...
o tediosas como pueden ser la contabilidad, la redacción de documentos, o la gestión 
...
l programar orientando a objetos se describe la secuencia que debe seguir el programa para resolver un problema dado.

La diferencia con otras formas de programación imperativas como la programación estructurada es que

En la orientación a objetos se hace uso de estructuras de datos llamadas objetos 
Aglutinan propiedades v métodos conjuntamente 
