...
Proporciona un marco para administrar netfilter, así como una interfaz de línea de comandos para manipular el firewall. 
...
Podemos comprobar si tenemos el paquete instalado: 

    dpkg -l | grep ufw

Instalación del paquete por si no lo tuviéramos: 
...
O bien ir agregando sudo al comienzo de todos los comandos
