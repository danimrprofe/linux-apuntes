...
def main():
    ...
    bg = pygame.image.load(os.path.join(carpeta_juego, "fondo.png")).convert_alpha()
...
#REST OF ITEMS ARE BLIT'D TO SCREEN.
    ...
    pelota = PelotaPong(os.path.join(carpeta_juego, "hadouken.png"))
    ...
    pygame.mixer.music.load(os.path.join(carpeta_juego, "guile.mp3"))
